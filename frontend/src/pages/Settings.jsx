        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div>
            ...
            <input
              ...
              className="w-full md:w-1/2 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 border p-2"
            />
          </div>
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 transition-all duration-300 active:scale-95 shadow-md shadow-indigo-500/20 disabled:opacity-50"
            >
